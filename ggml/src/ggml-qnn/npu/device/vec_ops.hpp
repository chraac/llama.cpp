...
inline HVX_Vector vec_dot_product_vqf32_q40_f32(const npu_device_block_q4_0 * src0,
    ...
    return vec_dot_product_quant_impl<npu_device_block_q4_0, float, HVX_Vector, load_dequant_vec_q40_qf32_6blocks,
                                      load_dequant_vec_q40_qf32_4blocks, load_dequant_vec_q40_qf32_2blocks,
                                      load_dequant_vec_q40_qf32_1block, vec_reduction_qf32>(
