...
dma_transfer::dma_transfer() {
    ...
    dma_desc_set_order(_dma_1d_desc0, 1);
    dma_desc_set_bypasssrc(_dma_1d_desc0, 1);  // for dram
    dma_desc_set_bypassdst(_dma_1d_desc0, 0);  // for vtcm
    ...
    dma_desc_set_order(_dma_1d_desc1, 1);
    dma_desc_set_bypasssrc(_dma_1d_desc1, 1);  // for dram
    dma_desc_set_bypassdst(_dma_1d_desc1, 0);  // for vtcm
